    ...
    function setup() {
        ...
        numFish = floor(map(width * height, 300000, 3000000, 2, 20, true));//calculate initial num of fish
        maxFish = numFish * 2;
        useComplexTailAnimation = (numFish < 20); //if there are too many fish disable complex tail animation to save cpu usage
        useNeon = (numFish < 20) //if we're bigger than a certain amount, disable neon to help pi survive
